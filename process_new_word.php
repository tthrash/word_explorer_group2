<?php
	...
	$query = "INSERT INTO word_list VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";	
    $stmt = $db->prepare($query);
    $stmt->bind_param('ssssssssssssssssss',$topic, $image, $english, $telugu, $hindi, $kannada, $gujarathi, $malayalam, $telugu_in_english, $english_in_telugu, 
	$hindi_in_english, $english_in_hindi, $kannada_in_english, $english_in_kannada, $gujarathi_in_english, $english_in_gujarathi, $malayalam_in_english, $english_in_malayalam);
    $stmt->execute();
